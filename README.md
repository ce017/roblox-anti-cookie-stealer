...
> Using Discord too? Token theft there works differently (LevelDB, not SQLite)
> and needs different detection - see
> [discord-anti-token-stealer](https://github.com/ce017/discord-anti-token-stealer).
